...
for i in np.arange(1850, 2011, 5): 
    ...
    # creates new coordinates named “lat” and “lon” by taking the values from the existing “geolat” and “geolon” coordinates. 
    # The primary reason for doing this is that the xe.Regridder interpolation function 
    # requires the dataset to have latitude and longitude coordinates named “lat” and “lon”, respectively, to work properly.
